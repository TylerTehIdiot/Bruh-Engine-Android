...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Bruh Engine Android Port'],
			['M.A. Jigsaw',		    'majigsaw',		    'Psych Engine Android',	 'https://www.youtube.com/channel/UC2Sk7vtPzOvbVzdVTWrribQ',	'0xFFC30085'],
			['TylerTehNub',		    'tylol',		    'Main Coder of Bruh Engine',	 'https://twitter.com/Ty_1991',	'0xFFFFFFFF'],
			['Psych Engine Team'],
